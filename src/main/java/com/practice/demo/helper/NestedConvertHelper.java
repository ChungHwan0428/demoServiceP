package com.practice.demo.helper;
...
public class NestedConvertHelper<K,E,D>{
    ...
    public static <K,E,D> NestedConvertHelper newInstance(List<E> entities, Function<E,D> toDto, Function<E,E> getParent, Function<E,K> getKey,
